...
Opening! 
======
If you are interested in **AI Infrastructure, Agent Infra, LLM for System, LLMs Fine-Tuning and Inference/Serving, HPC for AI**, we are actively looking for motivated students at different levels (Postdoc, PhD, MSc, Undergraduate, etc.) to reach out and join us!
...
<div
  id="visitor-map-container"
  role="link"
  tabindex="0"
  title="Click to view detailed visitor statistics"
  aria-label="Open detailed visitor statistics"
  style="display: inline-block; max-width: 100%; cursor: pointer;"
>
  <script
    src="https://statable.com/js/q6651bedcc/t/mw.js"
    data-id="3203188"
    data-period="90d"
...
(function () {
  ...
  function initializeVisitorMapLink() {
    ...
    function openStatistics(event) {
      /*
       * Preserve any link created inside the widget itself,
       * including the service attribution link.
       */
      if (
        event.target &&
    ...
    /*
     * The third argument, true, uses the capture phase.
     * This makes the handler more reliable even if an element
     * inside the map stops normal event propagation.
     */
    mapContainer.addEventListener("click", openStatistics, true);

    /*
     * Keyboard accessibility:
     * Enter or Space opens the statistics page.
     */
